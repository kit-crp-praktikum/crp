...
template <class T> void save_vector(const std::string &file_name, const std::vector<T> &vec)
{
...
template <class T> std::vector<T> load_vector(const std::string &file_name)
{
...
template <> inline void save_vector<std::string>(const std::string &file_name, const std::vector<std::string> &vec)
{
    std::ofstream out(file_name, std::ios::binary);
...
template <> inline std::vector<std::string> load_vector<std::string>(const std::string &file_name)
{
...
template <class T> void save_value(const std::string &file_name, const T &val)
{
    save_vector(file_name, std::vector<T>{val});
}

template <class T> T load_value(const std::string &file_name)
{
